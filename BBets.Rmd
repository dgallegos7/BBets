...
Knowing that Brownlow is giving a 2:1 bet that at least two people in the same class have the same birthday, we will be going over the results of the wager to see if they are fair odds in Brownlows earnings. Having the mean of the 40 teachers and subtracting two and adding two standard deviations, we can come up with another way to see if this hypothesis is fair on matching birthdays in a 35 person class. 
...
favstats(teachers)
```
We had to mess with the numbers for a while to make this bet fair, and the number we got for a 1:40 bet was an odd of 4.38 which got us as close to zero as possible at a mean of 1.353 that Brownlow makes for his bet. This means my chances of making money like Brownlow are pretty good. 
